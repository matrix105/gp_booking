...
const cards = [
  ...
  },
  {
    ...
    description: "",
    pic:
      "https://www.clickclinic.com.au/x/cdn/?https://storage.googleapis.com/production-websitebuilder-v1-0-7/357/164357/ZgRtJ5KR/7d4d00ce9289475e83b252268a73b058",
  },
];

function Home(props) {
  if (window.innerHeight < 1024) console.log(window.innerHeight);
  if (localStorage.getItem("role") === "4") cards.shift();
